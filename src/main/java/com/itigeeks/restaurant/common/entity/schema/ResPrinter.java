...
@NamedQueries({@NamedQuery(name = "ResPrinter.countAll",
    query = "SELECT COUNT(x) FROM ResPrinter x")})
public class ResPrinter extends AbstractEntity implements Serializable {
  ...
  // link
  // "printerModelId" (column "printer_model_id") is not defined by itself because used as FK in a
  // link
