...
@NamedQueries({@NamedQuery(name = "ResQuantityType.countAll",
    query = "SELECT COUNT(x) FROM ResQuantityType x")})
public class ResQuantityType extends AbstractEntity implements Serializable {
  ...
  public void setListOfResQuantityTypeConversion2(
      List<ResQuantityTypeConversion> listOfResQuantityTypeConversion2) {
  ...
  public void setListOfResQuantityTypeConversion(
      List<ResQuantityTypeConversion> listOfResQuantityTypeConversion) {
