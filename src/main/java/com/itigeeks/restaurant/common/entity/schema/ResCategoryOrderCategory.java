...
@NamedQueries ( {
  @NamedQuery ( name="ResCategoryOrderCategory.countAll", query="SELECT COUNT(x) FROM ResCategoryOrderCategory x" )
} )
public class ResCategoryOrderCategory extends AbstractEntity implements Serializable
{
    ...
    // ENTITY DATA FIELDS 
    //----------------------------------------------------------------------    
	// "orderCategoryId" (column "order_category_id") is not defined by itself because used as FK in a link 
