...
/**
 * Persistent class for entity stored in table "res_customer_comment"
 * 
...
@Entity
@Table(name = "res_customer_comment", catalog = "viceroy")
// Define named queries here
@NamedQueries({@NamedQuery(name = "ResCustomerComment.countAll",
    query = "SELECT COUNT(x) FROM ResCustomerComment x")})
