...
@NamedQueries({@NamedQuery(name = "ResVoucherExclusions.countAll",
    query = "SELECT COUNT(x) FROM ResVoucherExclusions x")})
public class ResVoucherExclusions extends AbstractEntity implements Serializable {
  ...
  // "exclusiveOrderTypeId" (column "exclusive_order_type_id") is not defined by itself because used
  // as FK in a link
