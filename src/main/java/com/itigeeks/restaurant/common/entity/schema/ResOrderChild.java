...
@NamedQueries ( {
  @NamedQuery ( name="ResOrderChild.countAll", query="SELECT COUNT(x) FROM ResOrderChild x" )
} )
public class ResOrderChild extends AbstractEntity implements Serializable
{
	...
	// "promotionProductParentId" (column "promotion_product_parent_id") is not defined by itself because used as FK in a link 
    ...
    public void setListOfResSpecialInstructions( List<ResSpecialInstructions> listOfResSpecialInstructions )
    {
