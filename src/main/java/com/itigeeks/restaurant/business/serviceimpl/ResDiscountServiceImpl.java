...
public class ResDiscountServiceImpl implements ResDiscountService {
	...
	{
		return 	resDiscountDAO.load(  criteria ,  startPage ,  pageSize ,  sortField,  ascending , QueryConjunctionType.AND );
	...
	{
		return 	resDiscountDAO.load(  criteria ,  startPage ,  pageSize ,  sortField,  ascending , QueryConjunctionType.OR );
