...
public class ResProductWithWithoutServiceImpl implements ResProductWithWithoutService {
	...
	{
		return 	resProductWithWithoutDAO.load(  criteria ,  startPage ,  pageSize ,  sortField,  ascending , QueryConjunctionType.AND );
	...
	{
		return 	resProductWithWithoutDAO.load(  criteria ,  startPage ,  pageSize ,  sortField,  ascending , QueryConjunctionType.OR );
