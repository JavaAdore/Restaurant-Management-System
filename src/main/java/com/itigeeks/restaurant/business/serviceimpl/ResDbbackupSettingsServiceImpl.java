...
public class ResDbbackupSettingsServiceImpl implements ResDbbackupSettingsService {
	...
	{
		return 	resDbbackupSettingsDAO.load(  criteria ,  startPage ,  pageSize ,  sortField,  ascending , QueryConjunctionType.AND );
	...
	{
		return 	resDbbackupSettingsDAO.load(  criteria ,  startPage ,  pageSize ,  sortField,  ascending , QueryConjunctionType.OR );
