...
public class ResFloorServiceImpl implements ResFloorService {
  ...
  @Override
  public List<ResFloor> loadWithAllCriteria(Map<String, Object> criteria, Integer startPage,
      Integer pageSize) {
    return loadWithAllCriteria(criteria, startPage, pageSize, null, null);
  ...
  @Override
  public List<ResFloor> loadWithAnyCriteria(Map<String, Object> criteria, Integer startPage,
      Integer pageSize) {
  ...
  public List<ResFloor> loadWithAllCriteria(Map<String, Object> criteria, Integer startPage,
    ...
    return resFloorDAO.load(criteria, startPage, pageSize, sortField, ascending,
