...
public class ResOrderStatusServiceImpl implements ResOrderStatusService {
	...
	{
		return 	resOrderStatusDAO.load(  criteria ,  startPage ,  pageSize ,  sortField,  ascending , QueryConjunctionType.AND );
	...
	{
		return 	resOrderStatusDAO.load(  criteria ,  startPage ,  pageSize ,  sortField,  ascending , QueryConjunctionType.OR );
