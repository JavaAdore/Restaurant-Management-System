...
public class ResTableTransactionsServiceImpl implements ResTableTransactionsService {
	...
	{
		return 	resTableTransactionsDAO.load(  criteria ,  startPage ,  pageSize ,  sortField,  ascending , QueryConjunctionType.AND );
	...
	{
		return 	resTableTransactionsDAO.load(  criteria ,  startPage ,  pageSize ,  sortField,  ascending , QueryConjunctionType.OR );
