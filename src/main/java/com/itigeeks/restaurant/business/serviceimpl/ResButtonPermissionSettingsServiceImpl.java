...
public class ResButtonPermissionSettingsServiceImpl implements ResButtonPermissionSettingsService {
	...
	{
		return 	resButtonPermissionSettingsDAO.load(  criteria ,  startPage ,  pageSize ,  sortField,  ascending , QueryConjunctionType.AND );
	...
	{
		return 	resButtonPermissionSettingsDAO.load(  criteria ,  startPage ,  pageSize ,  sortField,  ascending , QueryConjunctionType.OR );
