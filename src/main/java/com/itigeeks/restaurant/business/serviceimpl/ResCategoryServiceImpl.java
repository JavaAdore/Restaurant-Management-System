...
public class ResCategoryServiceImpl implements ResCategoryService {
	...
	{
		return 	resCategoryDAO.load(  criteria ,  startPage ,  pageSize ,  sortField,  ascending , QueryConjunctionType.AND );
	...
	{
		return 	resCategoryDAO.load(  criteria ,  startPage ,  pageSize ,  sortField,  ascending , QueryConjunctionType.OR );
