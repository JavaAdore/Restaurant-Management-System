...
public class ResReservationTimeServiceImpl implements ResReservationTimeService {
	...
	{
		return 	resReservationTimeDAO.load(  criteria ,  startPage ,  pageSize ,  sortField,  ascending , QueryConjunctionType.AND );
	...
	{
		return 	resReservationTimeDAO.load(  criteria ,  startPage ,  pageSize ,  sortField,  ascending , QueryConjunctionType.OR );
