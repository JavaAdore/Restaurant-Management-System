...
public class ResVoucherServiceImpl implements ResVoucherService {
  ...
  @Override
  public List<ResVoucher> loadWithAllCriteria(Map<String, Object> criteria, Integer startPage,
      Integer pageSize) {
    return loadWithAllCriteria(criteria, startPage, pageSize, null, null);
  ...
  @Override
  public List<ResVoucher> loadWithAnyCriteria(Map<String, Object> criteria, Integer startPage,
      Integer pageSize) {
  ...
  public List<ResVoucher> loadWithAllCriteria(Map<String, Object> criteria, Integer startPage,
    ...
    return resVoucherDAO.load(criteria, startPage, pageSize, sortField, ascending,
