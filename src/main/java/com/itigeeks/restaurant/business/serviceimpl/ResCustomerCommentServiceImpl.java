...
public class ResCustomerCommentServiceImpl implements ResCustomerCommentService {
	...
	{
		return 	resCustomerCommentDAO.load(  criteria ,  startPage ,  pageSize ,  sortField,  ascending , QueryConjunctionType.AND );
	...
	{
		return 	resCustomerCommentDAO.load(  criteria ,  startPage ,  pageSize ,  sortField,  ascending , QueryConjunctionType.OR );
