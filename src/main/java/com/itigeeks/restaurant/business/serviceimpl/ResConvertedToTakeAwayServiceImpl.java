...
public class ResConvertedToTakeAwayServiceImpl implements ResConvertedToTakeAwayService {
	...
	{
		return 	resConvertedToTakeAwayDAO.load(  criteria ,  startPage ,  pageSize ,  sortField,  ascending , QueryConjunctionType.AND );
	...
	{
		return 	resConvertedToTakeAwayDAO.load(  criteria ,  startPage ,  pageSize ,  sortField,  ascending , QueryConjunctionType.OR );
