...
public class ResOrderCategoryServiceImpl implements ResOrderCategoryService {
	...
	{
		return 	resOrderCategoryDAO.load(  criteria ,  startPage ,  pageSize ,  sortField,  ascending , QueryConjunctionType.AND );
	...
	{
		return 	resOrderCategoryDAO.load(  criteria ,  startPage ,  pageSize ,  sortField,  ascending , QueryConjunctionType.OR );
