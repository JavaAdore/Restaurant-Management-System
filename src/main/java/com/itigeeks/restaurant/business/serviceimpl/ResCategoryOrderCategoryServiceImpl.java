...
public class ResCategoryOrderCategoryServiceImpl implements ResCategoryOrderCategoryService {
	...
	{
		return 	resCategoryOrderCategoryDAO.load(  criteria ,  startPage ,  pageSize ,  sortField,  ascending , QueryConjunctionType.AND );
	...
	{
		return 	resCategoryOrderCategoryDAO.load(  criteria ,  startPage ,  pageSize ,  sortField,  ascending , QueryConjunctionType.OR );
