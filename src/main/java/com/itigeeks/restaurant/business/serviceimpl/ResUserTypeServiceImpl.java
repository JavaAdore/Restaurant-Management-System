...
public class ResUserTypeServiceImpl implements ResUserTypeService {
  ...
  @Override
  public List<ResUserType> loadWithAllCriteria(Map<String, Object> criteria, Integer startPage,
      Integer pageSize) {
    return loadWithAllCriteria(criteria, startPage, pageSize, null, null);
  ...
  @Override
  public List<ResUserType> loadWithAnyCriteria(Map<String, Object> criteria, Integer startPage,
      Integer pageSize) {
  ...
  public List<ResUserType> loadWithAllCriteria(Map<String, Object> criteria, Integer startPage,
    ...
    return resUserTypeDAO.load(criteria, startPage, pageSize, sortField, ascending,
