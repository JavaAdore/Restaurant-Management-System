...
public class ResCityServiceImpl implements ResCityService {
  ...
  @Override
  public List<ResCity> loadWithAllCriteria(Map<String, Object> criteria, Integer startPage,
      Integer pageSize) {
    return loadWithAllCriteria(criteria, startPage, pageSize, null, null);
  ...
  @Override
  public List<ResCity> loadWithAnyCriteria(Map<String, Object> criteria, Integer startPage,
      Integer pageSize) {
  ...
  public List<ResCity> loadWithAllCriteria(Map<String, Object> criteria, Integer startPage,
    ...
    return resCityDAO.load(criteria, startPage, pageSize, sortField, ascending,
