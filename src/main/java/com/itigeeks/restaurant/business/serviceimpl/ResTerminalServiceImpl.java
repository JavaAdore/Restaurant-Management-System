...
public class ResTerminalServiceImpl implements ResTerminalService {
	...
	{
		return 	resTerminalDAO.load(  criteria ,  startPage ,  pageSize ,  sortField,  ascending , QueryConjunctionType.AND );
	...
	{
		return 	resTerminalDAO.load(  criteria ,  startPage ,  pageSize ,  sortField,  ascending , QueryConjunctionType.OR );
