...
public class ResOrderServiceImpl implements ResOrderService {
  ...
  @Override
  public List<ResOrder> loadWithAllCriteria(Map<String, Object> criteria, Integer startPage,
      Integer pageSize) {
    return loadWithAllCriteria(criteria, startPage, pageSize, null, null);
  ...
  @Override
  public List<ResOrder> loadWithAnyCriteria(Map<String, Object> criteria, Integer startPage,
      Integer pageSize) {
  ...
  public List<ResOrder> loadWithAllCriteria(Map<String, Object> criteria, Integer startPage,
    ...
    return resOrderDAO.load(criteria, startPage, pageSize, sortField, ascending,
