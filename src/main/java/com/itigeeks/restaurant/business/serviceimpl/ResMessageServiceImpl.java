...
public class ResMessageServiceImpl implements ResMessageService {
  ...
  @Override
  public List<ResMessage> loadWithAllCriteria(Map<String, Object> criteria, Integer startPage,
      Integer pageSize) {
    return loadWithAllCriteria(criteria, startPage, pageSize, null, null);
  ...
  @Override
  public List<ResMessage> loadWithAnyCriteria(Map<String, Object> criteria, Integer startPage,
      Integer pageSize) {
  ...
  public List<ResMessage> loadWithAllCriteria(Map<String, Object> criteria, Integer startPage,
    ...
    return resMessageDAO.load(criteria, startPage, pageSize, sortField, ascending,
