...
public class ResQuantityTypeConversionServiceImpl implements ResQuantityTypeConversionService {
	...
	{
		return 	resQuantityTypeConversionDAO.load(  criteria ,  startPage ,  pageSize ,  sortField,  ascending , QueryConjunctionType.AND );
	...
	{
		return 	resQuantityTypeConversionDAO.load(  criteria ,  startPage ,  pageSize ,  sortField,  ascending , QueryConjunctionType.OR );
