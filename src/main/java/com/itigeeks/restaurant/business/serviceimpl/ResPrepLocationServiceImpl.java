...
public class ResPrepLocationServiceImpl implements ResPrepLocationService {
  ...
  @Override
  public List<ResPrepLocation> loadWithAllCriteria(Map<String, Object> criteria, Integer startPage,
      Integer pageSize) {
    return loadWithAllCriteria(criteria, startPage, pageSize, null, null);
  ...
  @Override
  public List<ResPrepLocation> loadWithAnyCriteria(Map<String, Object> criteria, Integer startPage,
      Integer pageSize) {
  ...
  public List<ResPrepLocation> loadWithAllCriteria(Map<String, Object> criteria, Integer startPage,
    ...
    return resPrepLocationDAO.load(criteria, startPage, pageSize, sortField, ascending,
