...
public class ResFlaggedOccassionServiceImpl implements ResFlaggedOccassionService {
	...
	{
		return 	resFlaggedOccassionDAO.load(  criteria ,  startPage ,  pageSize ,  sortField,  ascending , QueryConjunctionType.AND );
	...
	{
		return 	resFlaggedOccassionDAO.load(  criteria ,  startPage ,  pageSize ,  sortField,  ascending , QueryConjunctionType.OR );
