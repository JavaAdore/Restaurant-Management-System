...
public class ResCardTypeServiceImpl implements ResCardTypeService {
  ...
  @Override
  public List<ResCardType> loadWithAllCriteria(Map<String, Object> criteria, Integer startPage,
      Integer pageSize) {
    return loadWithAllCriteria(criteria, startPage, pageSize, null, null);
  ...
  @Override
  public List<ResCardType> loadWithAnyCriteria(Map<String, Object> criteria, Integer startPage,
      Integer pageSize) {
  ...
  public List<ResCardType> loadWithAllCriteria(Map<String, Object> criteria, Integer startPage,
    ...
    return resCardTypeDAO.load(criteria, startPage, pageSize, sortField, ascending,
