...
public class ResNumberIdentifierServiceImpl implements ResNumberIdentifierService {
	...
	{
		return 	resNumberIdentifierDAO.load(  criteria ,  startPage ,  pageSize ,  sortField,  ascending , QueryConjunctionType.AND );
	...
	{
		return 	resNumberIdentifierDAO.load(  criteria ,  startPage ,  pageSize ,  sortField,  ascending , QueryConjunctionType.OR );
