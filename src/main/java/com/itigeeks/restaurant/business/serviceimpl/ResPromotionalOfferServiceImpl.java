...
public class ResPromotionalOfferServiceImpl implements ResPromotionalOfferService {
	...
	{
		return 	resPromotionalOfferDAO.load(  criteria ,  startPage ,  pageSize ,  sortField,  ascending , QueryConjunctionType.AND );
	...
	{
		return 	resPromotionalOfferDAO.load(  criteria ,  startPage ,  pageSize ,  sortField,  ascending , QueryConjunctionType.OR );
