...
public class ResProductIngredientServiceImpl implements ResProductIngredientService {
	...
	{
		return 	resProductIngredientDAO.load(  criteria ,  startPage ,  pageSize ,  sortField,  ascending , QueryConjunctionType.AND );
	...
	{
		return 	resProductIngredientDAO.load(  criteria ,  startPage ,  pageSize ,  sortField,  ascending , QueryConjunctionType.OR );
