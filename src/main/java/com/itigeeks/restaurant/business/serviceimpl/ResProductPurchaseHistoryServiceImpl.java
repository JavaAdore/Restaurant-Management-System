...
public class ResProductPurchaseHistoryServiceImpl implements ResProductPurchaseHistoryService {
	...
	{
		return 	resProductPurchaseHistoryDAO.load(  criteria ,  startPage ,  pageSize ,  sortField,  ascending , QueryConjunctionType.AND );
	...
	{
		return 	resProductPurchaseHistoryDAO.load(  criteria ,  startPage ,  pageSize ,  sortField,  ascending , QueryConjunctionType.OR );
