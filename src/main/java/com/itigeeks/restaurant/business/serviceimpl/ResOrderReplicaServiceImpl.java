...
public class ResOrderReplicaServiceImpl implements ResOrderReplicaService {
	...
	{
		return 	resOrderReplicaDAO.load(  criteria ,  startPage ,  pageSize ,  sortField,  ascending , QueryConjunctionType.AND );
	...
	{
		return 	resOrderReplicaDAO.load(  criteria ,  startPage ,  pageSize ,  sortField,  ascending , QueryConjunctionType.OR );
