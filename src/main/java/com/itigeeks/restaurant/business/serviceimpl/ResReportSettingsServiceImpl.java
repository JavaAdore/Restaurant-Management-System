...
public class ResReportSettingsServiceImpl implements ResReportSettingsService {
	...
	{
		return 	resReportSettingsDAO.load(  criteria ,  startPage ,  pageSize ,  sortField,  ascending , QueryConjunctionType.AND );
	...
	{
		return 	resReportSettingsDAO.load(  criteria ,  startPage ,  pageSize ,  sortField,  ascending , QueryConjunctionType.OR );
