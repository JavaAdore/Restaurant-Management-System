...
public class ResCustomerServiceImpl implements ResCustomerService {
  ...
  @Override
  public List<ResCustomer> loadWithAllCriteria(Map<String, Object> criteria, Integer startPage,
      Integer pageSize) {
    return loadWithAllCriteria(criteria, startPage, pageSize, null, null);
  ...
  @Override
  public List<ResCustomer> loadWithAnyCriteria(Map<String, Object> criteria, Integer startPage,
      Integer pageSize) {
  ...
  public List<ResCustomer> loadWithAllCriteria(Map<String, Object> criteria, Integer startPage,
    ...
    return resCustomerDAO.load(criteria, startPage, pageSize, sortField, ascending,
