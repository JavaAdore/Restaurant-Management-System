...
public class ResCloakRoomServiceImpl implements ResCloakRoomService {
	...
	{
		return 	resCloakRoomDAO.load(  criteria ,  startPage ,  pageSize ,  sortField,  ascending , QueryConjunctionType.AND );
	...
	{
		return 	resCloakRoomDAO.load(  criteria ,  startPage ,  pageSize ,  sortField,  ascending , QueryConjunctionType.OR );
