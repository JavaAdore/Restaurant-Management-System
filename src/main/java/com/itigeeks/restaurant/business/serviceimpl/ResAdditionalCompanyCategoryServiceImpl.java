...
public class ResAdditionalCompanyCategoryServiceImpl implements ResAdditionalCompanyCategoryService {
	...
	{
		return 	resAdditionalCompanyCategoryDAO.load(  criteria ,  startPage ,  pageSize ,  sortField,  ascending , QueryConjunctionType.AND );
	...
	{
		return 	resAdditionalCompanyCategoryDAO.load(  criteria ,  startPage ,  pageSize ,  sortField,  ascending , QueryConjunctionType.OR );
