...
public class ResPaymentServiceImpl implements ResPaymentService {
	...
	{
		return 	resPaymentDAO.load(  criteria ,  startPage ,  pageSize ,  sortField,  ascending , QueryConjunctionType.AND );
	...
	{
		return 	resPaymentDAO.load(  criteria ,  startPage ,  pageSize ,  sortField,  ascending , QueryConjunctionType.OR );
