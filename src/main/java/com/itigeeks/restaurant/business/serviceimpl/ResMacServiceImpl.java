...
public class ResMacServiceImpl implements ResMacService {
  ...
  @Override
  public List<ResMac> loadWithAllCriteria(Map<String, Object> criteria, Integer startPage,
      Integer pageSize) {
    return loadWithAllCriteria(criteria, startPage, pageSize, null, null);
  ...
  @Override
  public List<ResMac> loadWithAnyCriteria(Map<String, Object> criteria, Integer startPage,
      Integer pageSize) {
  ...
  public List<ResMac> loadWithAllCriteria(Map<String, Object> criteria, Integer startPage,
    ...
    return resMacDAO.load(criteria, startPage, pageSize, sortField, ascending,
