...
public class ResZreportLogServiceImpl implements ResZreportLogService {
	...
	{
		return 	resZreportLogDAO.load(  criteria ,  startPage ,  pageSize ,  sortField,  ascending , QueryConjunctionType.AND );
	...
	{
		return 	resZreportLogDAO.load(  criteria ,  startPage ,  pageSize ,  sortField,  ascending , QueryConjunctionType.OR );
