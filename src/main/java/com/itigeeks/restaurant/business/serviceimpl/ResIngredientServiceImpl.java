...
public class ResIngredientServiceImpl implements ResIngredientService {
  ...
  @Override
  public List<ResIngredient> loadWithAllCriteria(Map<String, Object> criteria, Integer startPage,
      Integer pageSize) {
    return loadWithAllCriteria(criteria, startPage, pageSize, null, null);
  ...
  @Override
  public List<ResIngredient> loadWithAnyCriteria(Map<String, Object> criteria, Integer startPage,
      Integer pageSize) {
  ...
  public List<ResIngredient> loadWithAllCriteria(Map<String, Object> criteria, Integer startPage,
    ...
    return resIngredientDAO.load(criteria, startPage, pageSize, sortField, ascending,
