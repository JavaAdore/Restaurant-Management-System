...
public class ResCallLogServiceImpl implements ResCallLogService {
	...
	{
		return 	resCallLogDAO.load(  criteria ,  startPage ,  pageSize ,  sortField,  ascending , QueryConjunctionType.AND );
	...
	{
		return 	resCallLogDAO.load(  criteria ,  startPage ,  pageSize ,  sortField,  ascending , QueryConjunctionType.OR );
