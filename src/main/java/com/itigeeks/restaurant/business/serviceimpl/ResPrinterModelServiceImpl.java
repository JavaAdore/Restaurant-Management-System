...
public class ResPrinterModelServiceImpl implements ResPrinterModelService {
  ...
  @Override
  public List<ResPrinterModel> loadWithAllCriteria(Map<String, Object> criteria, Integer startPage,
      Integer pageSize) {
    return loadWithAllCriteria(criteria, startPage, pageSize, null, null);
  ...
  @Override
  public List<ResPrinterModel> loadWithAnyCriteria(Map<String, Object> criteria, Integer startPage,
      Integer pageSize) {
  ...
  public List<ResPrinterModel> loadWithAllCriteria(Map<String, Object> criteria, Integer startPage,
    ...
    return resPrinterModelDAO.load(criteria, startPage, pageSize, sortField, ascending,
