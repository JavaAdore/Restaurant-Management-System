...
public class ResProductWasteHistoryServiceImpl implements ResProductWasteHistoryService {
	...
	{
		return 	resProductWasteHistoryDAO.load(  criteria ,  startPage ,  pageSize ,  sortField,  ascending , QueryConjunctionType.AND );
	...
	{
		return 	resProductWasteHistoryDAO.load(  criteria ,  startPage ,  pageSize ,  sortField,  ascending , QueryConjunctionType.OR );
