...
public class ResCustomerMessageServiceImpl implements ResCustomerMessageService {
	...
	{
		return 	resCustomerMessageDAO.load(  criteria ,  startPage ,  pageSize ,  sortField,  ascending , QueryConjunctionType.AND );
	...
	{
		return 	resCustomerMessageDAO.load(  criteria ,  startPage ,  pageSize ,  sortField,  ascending , QueryConjunctionType.OR );
