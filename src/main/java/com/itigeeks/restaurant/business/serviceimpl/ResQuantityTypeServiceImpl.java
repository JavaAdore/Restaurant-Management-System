...
public class ResQuantityTypeServiceImpl implements ResQuantityTypeService {
	...
	{
		return 	resQuantityTypeDAO.load(  criteria ,  startPage ,  pageSize ,  sortField,  ascending , QueryConjunctionType.AND );
	...
	{
		return 	resQuantityTypeDAO.load(  criteria ,  startPage ,  pageSize ,  sortField,  ascending , QueryConjunctionType.OR );
