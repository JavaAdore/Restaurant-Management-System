...
public class ResMessageStatusServiceImpl implements ResMessageStatusService {
	...
	{
		return 	resMessageStatusDAO.load(  criteria ,  startPage ,  pageSize ,  sortField,  ascending , QueryConjunctionType.AND );
	...
	{
		return 	resMessageStatusDAO.load(  criteria ,  startPage ,  pageSize ,  sortField,  ascending , QueryConjunctionType.OR );
