...
public class ResPrintBlockServiceImpl implements ResPrintBlockService {
	...
	{
		return 	resPrintBlockDAO.load(  criteria ,  startPage ,  pageSize ,  sortField,  ascending , QueryConjunctionType.AND );
	...
	{
		return 	resPrintBlockDAO.load(  criteria ,  startPage ,  pageSize ,  sortField,  ascending , QueryConjunctionType.OR );
