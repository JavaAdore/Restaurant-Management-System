 ...
 */
@Repository
public class ResAdditionalCompanyCategoryDAOImpl extends AbstractDAO implements
    ResAdditionalCompanyCategoryDAO, Serializable {
  ...
  public List<ResAdditionalCompanyCategory> load(Map<String, Object> criteria,
    ...
    return (List<ResAdditionalCompanyCategory>) super.load(ResAdditionalCompanyCategory.class,
