...
public class ResReservationInvoiceDAOImpl extends AbstractDAO implements ResReservationInvoiceDAO  , Serializable {
	...
	@Override
	public List<ResReservationInvoice> load(Map<String, Object> criteria,QueryConjunctionType conjuncationType) {
			
			return (List<ResReservationInvoice>) super.load(ResReservationInvoice.class , criteria ,  conjuncationType );
	}

	@Override
	public List<ResReservationInvoice> load(Map<String, Object> criteria, Integer startPage, Integer pageSize,QueryConjunctionType conjuncationType) {
	...
	@Override
	public List<ResReservationInvoice> load(Map<String, Object> criteria, Integer startPage, Integer pageSize,String sortField, Boolean ascending,QueryConjunctionType conjuncationType) {
			
		return (List<ResReservationInvoice>) super.load(ResReservationInvoice.class , criteria , startPage , pageSize ,  sortField , ascending ,  conjuncationType );
	}
