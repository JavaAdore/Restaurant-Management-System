 ...
 */
@Repository
public class ResLoyaltyPointsDAOImpl extends AbstractDAO implements ResLoyaltyPointsDAO,
    Serializable {
  ...
  public List<ResLoyaltyPoints> load(Map<String, Object> criteria, Integer startPage,
    ...
    return (List<ResLoyaltyPoints>) super.load(ResLoyaltyPoints.class, criteria, startPage,
