...
public class ResPrintBlockDAOImpl extends AbstractDAO implements ResPrintBlockDAO  , Serializable {
	...
	@Override
	public List<ResPrintBlock> load(Map<String, Object> criteria,QueryConjunctionType conjuncationType) {
	...
	public List<ResPrintBlock> load(Map<String, Object> criteria, Integer startPage, Integer pageSize,String sortField, Boolean ascending,QueryConjunctionType conjuncationType) {
		...
		return (List<ResPrintBlock>) super.load(ResPrintBlock.class , criteria , startPage , pageSize ,  sortField , ascending ,  conjuncationType );
	}
