 ...
 */
@Repository
public class ResReservationTypeDAOImpl extends AbstractDAO implements ResReservationTypeDAO,
    Serializable {
  ...
  public List<ResReservationType> load(Map<String, Object> criteria,
    ...
    return (List<ResReservationType>) super.load(ResReservationType.class, criteria,
        conjuncationType);
  }
  ...
  public List<ResReservationType> load(Map<String, Object> criteria, Integer startPage,
    ...
    return (List<ResReservationType>) super.load(ResReservationType.class, criteria, startPage,
