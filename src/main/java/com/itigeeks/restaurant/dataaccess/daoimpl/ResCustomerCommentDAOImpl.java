 ...
 */
@Repository
public class ResCustomerCommentDAOImpl extends AbstractDAO implements ResCustomerCommentDAO,
    Serializable {
  ...
  public List<ResCustomerComment> load(Map<String, Object> criteria,
    ...
    return (List<ResCustomerComment>) super.load(ResCustomerComment.class, criteria,
        conjuncationType);
  }
  ...
  public List<ResCustomerComment> load(Map<String, Object> criteria, Integer startPage,
    ...
    return (List<ResCustomerComment>) super.load(ResCustomerComment.class, criteria, startPage,
