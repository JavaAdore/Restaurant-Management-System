...
public class ResSpecialInstructionsDAOImpl extends AbstractDAO implements ResSpecialInstructionsDAO  , Serializable {
	...
	@Override
	public List<ResSpecialInstructions> load(Map<String, Object> criteria,QueryConjunctionType conjuncationType) {
			
			return (List<ResSpecialInstructions>) super.load(ResSpecialInstructions.class , criteria ,  conjuncationType );
	}
	...
	public List<ResSpecialInstructions> load(Map<String, Object> criteria, Integer startPage, Integer pageSize,String sortField, Boolean ascending,QueryConjunctionType conjuncationType) {
		...
		return (List<ResSpecialInstructions>) super.load(ResSpecialInstructions.class , criteria , startPage , pageSize ,  sortField , ascending ,  conjuncationType );
	}
