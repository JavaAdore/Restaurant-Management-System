 ...
 */
@Repository
public class ResCloakRoomStatusDAOImpl extends AbstractDAO implements ResCloakRoomStatusDAO,
    Serializable {
  ...
  public List<ResCloakRoomStatus> load(Map<String, Object> criteria,
    ...
    return (List<ResCloakRoomStatus>) super.load(ResCloakRoomStatus.class, criteria,
        conjuncationType);
  }
  ...
  public List<ResCloakRoomStatus> load(Map<String, Object> criteria, Integer startPage,
    ...
    return (List<ResCloakRoomStatus>) super.load(ResCloakRoomStatus.class, criteria, startPage,
