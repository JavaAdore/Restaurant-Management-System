...
public class ResOrderDeleteLogDAOImpl extends AbstractDAO implements ResOrderDeleteLogDAO  , Serializable {
	...
	@Override
	public List<ResOrderDeleteLog> load(Map<String, Object> criteria,QueryConjunctionType conjuncationType) {
			
			return (List<ResOrderDeleteLog>) super.load(ResOrderDeleteLog.class , criteria ,  conjuncationType );
	}

	@Override
	public List<ResOrderDeleteLog> load(Map<String, Object> criteria, Integer startPage, Integer pageSize,QueryConjunctionType conjuncationType) {
	...
	@Override
	public List<ResOrderDeleteLog> load(Map<String, Object> criteria, Integer startPage, Integer pageSize,String sortField, Boolean ascending,QueryConjunctionType conjuncationType) {
			
		return (List<ResOrderDeleteLog>) super.load(ResOrderDeleteLog.class , criteria , startPage , pageSize ,  sortField , ascending ,  conjuncationType );
	}
