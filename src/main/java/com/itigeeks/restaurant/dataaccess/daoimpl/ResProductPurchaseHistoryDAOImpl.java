 ...
 */
@Repository
public class ResProductPurchaseHistoryDAOImpl extends AbstractDAO implements
    ResProductPurchaseHistoryDAO, Serializable {
  ...
  public List<ResProductPurchaseHistory> load(Map<String, Object> criteria,
    ...
    return (List<ResProductPurchaseHistory>) super.load(ResProductPurchaseHistory.class, criteria,
        conjuncationType);
  }
