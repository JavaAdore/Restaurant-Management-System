 ...
 */
@Repository
public class ResDiscountProductDAOImpl extends AbstractDAO implements ResDiscountProductDAO,
    Serializable {
  ...
  public List<ResDiscountProduct> load(Map<String, Object> criteria,
    ...
    return (List<ResDiscountProduct>) super.load(ResDiscountProduct.class, criteria,
        conjuncationType);
  }
  ...
  public List<ResDiscountProduct> load(Map<String, Object> criteria, Integer startPage,
    ...
    return (List<ResDiscountProduct>) super.load(ResDiscountProduct.class, criteria, startPage,
