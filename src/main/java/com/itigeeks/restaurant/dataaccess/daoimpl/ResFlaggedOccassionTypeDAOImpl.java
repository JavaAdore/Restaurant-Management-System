 ...
 */
@Repository
public class ResFlaggedOccassionTypeDAOImpl extends AbstractDAO implements
    ResFlaggedOccassionTypeDAO, Serializable {
  ...
  public List<ResFlaggedOccassionType> load(Map<String, Object> criteria,
    ...
    return (List<ResFlaggedOccassionType>) super.load(ResFlaggedOccassionType.class, criteria,
        conjuncationType);
  }
