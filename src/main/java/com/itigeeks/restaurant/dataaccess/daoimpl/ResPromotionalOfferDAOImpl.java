 ...
 */
@Repository
public class ResPromotionalOfferDAOImpl extends AbstractDAO implements ResPromotionalOfferDAO,
    Serializable {
  ...
  public List<ResPromotionalOffer> load(Map<String, Object> criteria,
    ...
    return (List<ResPromotionalOffer>) super.load(ResPromotionalOffer.class, criteria,
        conjuncationType);
  }
  ...
  public List<ResPromotionalOffer> load(Map<String, Object> criteria, Integer startPage,
    ...
    return (List<ResPromotionalOffer>) super.load(ResPromotionalOffer.class, criteria, startPage,
