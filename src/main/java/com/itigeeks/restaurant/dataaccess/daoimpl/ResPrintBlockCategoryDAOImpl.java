...
public class ResPrintBlockCategoryDAOImpl extends AbstractDAO implements ResPrintBlockCategoryDAO  , Serializable {
	...
	@Override
	public List<ResPrintBlockCategory> load(Map<String, Object> criteria,QueryConjunctionType conjuncationType) {
			
			return (List<ResPrintBlockCategory>) super.load(ResPrintBlockCategory.class , criteria ,  conjuncationType );
	}
	...
	public List<ResPrintBlockCategory> load(Map<String, Object> criteria, Integer startPage, Integer pageSize,String sortField, Boolean ascending,QueryConjunctionType conjuncationType) {
		...
		return (List<ResPrintBlockCategory>) super.load(ResPrintBlockCategory.class , criteria , startPage , pageSize ,  sortField , ascending ,  conjuncationType );
	}
