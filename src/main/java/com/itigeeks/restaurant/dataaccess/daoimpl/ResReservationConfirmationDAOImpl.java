 ...
 */
@Repository
public class ResReservationConfirmationDAOImpl extends AbstractDAO implements
    ResReservationConfirmationDAO, Serializable {
  ...
  public List<ResReservationConfirmation> load(Map<String, Object> criteria,
    ...
    return (List<ResReservationConfirmation>) super.load(ResReservationConfirmation.class,
