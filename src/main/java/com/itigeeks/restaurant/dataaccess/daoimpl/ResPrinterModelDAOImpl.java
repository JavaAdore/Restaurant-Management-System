...
public class ResPrinterModelDAOImpl extends AbstractDAO implements ResPrinterModelDAO  , Serializable {
	...
	@Override
	public List<ResPrinterModel> load(Map<String, Object> criteria,QueryConjunctionType conjuncationType) {
			
			return (List<ResPrinterModel>) super.load(ResPrinterModel.class , criteria ,  conjuncationType );
	}

	@Override
	public List<ResPrinterModel> load(Map<String, Object> criteria, Integer startPage, Integer pageSize,QueryConjunctionType conjuncationType) {
	...
	@Override
	public List<ResPrinterModel> load(Map<String, Object> criteria, Integer startPage, Integer pageSize,String sortField, Boolean ascending,QueryConjunctionType conjuncationType) {
			
		return (List<ResPrinterModel>) super.load(ResPrinterModel.class , criteria , startPage , pageSize ,  sortField , ascending ,  conjuncationType );
	}
