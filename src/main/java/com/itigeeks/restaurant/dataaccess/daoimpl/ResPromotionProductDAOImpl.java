 ...
 */
@Repository
public class ResPromotionProductDAOImpl extends AbstractDAO implements ResPromotionProductDAO,
    Serializable {
  ...
  public List<ResPromotionProduct> load(Map<String, Object> criteria,
    ...
    return (List<ResPromotionProduct>) super.load(ResPromotionProduct.class, criteria,
        conjuncationType);
  }
  ...
  public List<ResPromotionProduct> load(Map<String, Object> criteria, Integer startPage,
    ...
    return (List<ResPromotionProduct>) super.load(ResPromotionProduct.class, criteria, startPage,
