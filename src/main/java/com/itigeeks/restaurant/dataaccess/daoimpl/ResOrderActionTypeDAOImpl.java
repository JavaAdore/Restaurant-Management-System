 ...
 */
@Repository
public class ResOrderActionTypeDAOImpl extends AbstractDAO implements ResOrderActionTypeDAO,
    Serializable {
  ...
  public List<ResOrderActionType> load(Map<String, Object> criteria,
    ...
    return (List<ResOrderActionType>) super.load(ResOrderActionType.class, criteria,
        conjuncationType);
  }
  ...
  public List<ResOrderActionType> load(Map<String, Object> criteria, Integer startPage,
    ...
    return (List<ResOrderActionType>) super.load(ResOrderActionType.class, criteria, startPage,
