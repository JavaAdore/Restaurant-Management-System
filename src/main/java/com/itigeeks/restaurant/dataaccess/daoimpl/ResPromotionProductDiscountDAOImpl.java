...
public class ResPromotionProductDiscountDAOImpl extends AbstractDAO implements ResPromotionProductDiscountDAO  , Serializable {
	...
	@Override
	public List<ResPromotionProductDiscount> load(Map<String, Object> criteria,QueryConjunctionType conjuncationType) {
			
			return (List<ResPromotionProductDiscount>) super.load(ResPromotionProductDiscount.class , criteria ,  conjuncationType );
	}

	@Override
	public List<ResPromotionProductDiscount> load(Map<String, Object> criteria, Integer startPage, Integer pageSize,QueryConjunctionType conjuncationType) {
	...
	@Override
	public List<ResPromotionProductDiscount> load(Map<String, Object> criteria, Integer startPage, Integer pageSize,String sortField, Boolean ascending,QueryConjunctionType conjuncationType) {
			
		return (List<ResPromotionProductDiscount>) super.load(ResPromotionProductDiscount.class , criteria , startPage , pageSize ,  sortField , ascending ,  conjuncationType );
	}
