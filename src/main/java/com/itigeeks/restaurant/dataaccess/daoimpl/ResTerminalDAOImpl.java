...
public class ResTerminalDAOImpl extends AbstractDAO implements ResTerminalDAO  , Serializable {
	...
	@Override
	public List<ResTerminal> load(Map<String, Object> criteria, Integer startPage, Integer pageSize,QueryConjunctionType conjuncationType) {
	...
	@Override
	public List<ResTerminal> load(Map<String, Object> criteria, Integer startPage, Integer pageSize,String sortField, Boolean ascending,QueryConjunctionType conjuncationType) {
			
		return (List<ResTerminal>) super.load(ResTerminal.class , criteria , startPage , pageSize ,  sortField , ascending ,  conjuncationType );
	}
