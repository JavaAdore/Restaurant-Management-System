...
public class ResPredefinedMessageDAOImpl extends AbstractDAO implements ResPredefinedMessageDAO  , Serializable {
	...
	@Override
	public List<ResPredefinedMessage> load(Map<String, Object> criteria,QueryConjunctionType conjuncationType) {
			
			return (List<ResPredefinedMessage>) super.load(ResPredefinedMessage.class , criteria ,  conjuncationType );
	}
	...
	public List<ResPredefinedMessage> load(Map<String, Object> criteria, Integer startPage, Integer pageSize,String sortField, Boolean ascending,QueryConjunctionType conjuncationType) {
		...
		return (List<ResPredefinedMessage>) super.load(ResPredefinedMessage.class , criteria , startPage , pageSize ,  sortField , ascending ,  conjuncationType );
	}
