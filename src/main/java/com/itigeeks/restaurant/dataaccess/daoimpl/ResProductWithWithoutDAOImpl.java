...
public class ResProductWithWithoutDAOImpl extends AbstractDAO implements ResProductWithWithoutDAO  , Serializable {
	...
	@Override
	public List<ResProductWithWithout> load(Map<String, Object> criteria,QueryConjunctionType conjuncationType) {
			
			return (List<ResProductWithWithout>) super.load(ResProductWithWithout.class , criteria ,  conjuncationType );
	}
	...
	public List<ResProductWithWithout> load(Map<String, Object> criteria, Integer startPage, Integer pageSize,String sortField, Boolean ascending,QueryConjunctionType conjuncationType) {
		...
		return (List<ResProductWithWithout>) super.load(ResProductWithWithout.class , criteria , startPage , pageSize ,  sortField , ascending ,  conjuncationType );
	}
