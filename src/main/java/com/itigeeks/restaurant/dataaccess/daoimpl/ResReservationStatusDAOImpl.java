...
public class ResReservationStatusDAOImpl extends AbstractDAO implements ResReservationStatusDAO  , Serializable {
	...
	@Override
	public List<ResReservationStatus> load(Map<String, Object> criteria,QueryConjunctionType conjuncationType) {
			
			return (List<ResReservationStatus>) super.load(ResReservationStatus.class , criteria ,  conjuncationType );
	}

	@Override
	public List<ResReservationStatus> load(Map<String, Object> criteria, Integer startPage, Integer pageSize,QueryConjunctionType conjuncationType) {
	...
	@Override
	public List<ResReservationStatus> load(Map<String, Object> criteria, Integer startPage, Integer pageSize,String sortField, Boolean ascending,QueryConjunctionType conjuncationType) {
			
		return (List<ResReservationStatus>) super.load(ResReservationStatus.class , criteria , startPage , pageSize ,  sortField , ascending ,  conjuncationType );
	}
