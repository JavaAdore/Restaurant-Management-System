...
public class ResQuantityTypeDAOImpl extends AbstractDAO implements ResQuantityTypeDAO  , Serializable {
	...
	@Override
	public List<ResQuantityType> load(Map<String, Object> criteria,QueryConjunctionType conjuncationType) {
	...
	public List<ResQuantityType> load(Map<String, Object> criteria, Integer startPage, Integer pageSize,String sortField, Boolean ascending,QueryConjunctionType conjuncationType) {
		...
		return (List<ResQuantityType>) super.load(ResQuantityType.class , criteria , startPage , pageSize ,  sortField , ascending ,  conjuncationType );
	}
