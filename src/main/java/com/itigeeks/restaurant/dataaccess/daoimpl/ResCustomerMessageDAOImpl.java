...
public class ResCustomerMessageDAOImpl extends AbstractDAO implements ResCustomerMessageDAO  , Serializable {
	...
	@Override
	public List<ResCustomerMessage> load(Map<String, Object> criteria,QueryConjunctionType conjuncationType) {
			
			return (List<ResCustomerMessage>) super.load(ResCustomerMessage.class , criteria ,  conjuncationType );
	}

	@Override
	public List<ResCustomerMessage> load(Map<String, Object> criteria, Integer startPage, Integer pageSize,QueryConjunctionType conjuncationType) {
	...
	@Override
	public List<ResCustomerMessage> load(Map<String, Object> criteria, Integer startPage, Integer pageSize,String sortField, Boolean ascending,QueryConjunctionType conjuncationType) {
			
		return (List<ResCustomerMessage>) super.load(ResCustomerMessage.class , criteria , startPage , pageSize ,  sortField , ascending ,  conjuncationType );
	}
