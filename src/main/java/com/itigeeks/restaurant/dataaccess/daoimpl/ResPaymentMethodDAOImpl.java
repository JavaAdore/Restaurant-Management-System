 ...
 */
@Repository
public class ResPaymentMethodDAOImpl extends AbstractDAO implements ResPaymentMethodDAO,
    Serializable {
  ...
  public List<ResPaymentMethod> load(Map<String, Object> criteria, Integer startPage,
    ...
    return (List<ResPaymentMethod>) super.load(ResPaymentMethod.class, criteria, startPage,
