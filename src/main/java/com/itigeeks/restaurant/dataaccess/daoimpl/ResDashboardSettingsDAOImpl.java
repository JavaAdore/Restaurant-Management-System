...
public class ResDashboardSettingsDAOImpl extends AbstractDAO implements ResDashboardSettingsDAO  , Serializable {
	...
	@Override
	public List<ResDashboardSettings> load(Map<String, Object> criteria,QueryConjunctionType conjuncationType) {
			
			return (List<ResDashboardSettings>) super.load(ResDashboardSettings.class , criteria ,  conjuncationType );
	}

	@Override
	public List<ResDashboardSettings> load(Map<String, Object> criteria, Integer startPage, Integer pageSize,QueryConjunctionType conjuncationType) {
	...
	@Override
	public List<ResDashboardSettings> load(Map<String, Object> criteria, Integer startPage, Integer pageSize,String sortField, Boolean ascending,QueryConjunctionType conjuncationType) {
			
		return (List<ResDashboardSettings>) super.load(ResDashboardSettings.class , criteria , startPage , pageSize ,  sortField , ascending ,  conjuncationType );
	}
