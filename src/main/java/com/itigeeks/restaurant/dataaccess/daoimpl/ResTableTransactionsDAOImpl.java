...
public class ResTableTransactionsDAOImpl extends AbstractDAO implements ResTableTransactionsDAO  , Serializable {
	...
	@Override
	public List<ResTableTransactions> load(Map<String, Object> criteria,QueryConjunctionType conjuncationType) {
			
			return (List<ResTableTransactions>) super.load(ResTableTransactions.class , criteria ,  conjuncationType );
	}
	...
	public List<ResTableTransactions> load(Map<String, Object> criteria, Integer startPage, Integer pageSize,String sortField, Boolean ascending,QueryConjunctionType conjuncationType) {
		...
		return (List<ResTableTransactions>) super.load(ResTableTransactions.class , criteria , startPage , pageSize ,  sortField , ascending ,  conjuncationType );
	}
