...
public class ResOrderCategoryDAOImpl extends AbstractDAO implements ResOrderCategoryDAO  , Serializable {
	...
	@Override
	public List<ResOrderCategory> load(Map<String, Object> criteria,QueryConjunctionType conjuncationType) {
	...
	public List<ResOrderCategory> load(Map<String, Object> criteria, Integer startPage, Integer pageSize,String sortField, Boolean ascending,QueryConjunctionType conjuncationType) {
		...
		return (List<ResOrderCategory>) super.load(ResOrderCategory.class , criteria , startPage , pageSize ,  sortField , ascending ,  conjuncationType );
	}
