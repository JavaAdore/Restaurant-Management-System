 ...
 */
@Repository
public class ResMessageStatusDAOImpl extends AbstractDAO implements ResMessageStatusDAO,
    Serializable {
  ...
  public List<ResMessageStatus> load(Map<String, Object> criteria, Integer startPage,
    ...
    return (List<ResMessageStatus>) super.load(ResMessageStatus.class, criteria, startPage,
