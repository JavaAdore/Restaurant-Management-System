...
public class ResCategoryOrderCategoryDAOImpl extends AbstractDAO implements ResCategoryOrderCategoryDAO  , Serializable {
	...
	@Override
	public List<ResCategoryOrderCategory> load(Map<String, Object> criteria,QueryConjunctionType conjuncationType) {
			
			return (List<ResCategoryOrderCategory>) super.load(ResCategoryOrderCategory.class , criteria ,  conjuncationType );
	}

	@Override
	public List<ResCategoryOrderCategory> load(Map<String, Object> criteria, Integer startPage, Integer pageSize,QueryConjunctionType conjuncationType) {
	...
	@Override
	public List<ResCategoryOrderCategory> load(Map<String, Object> criteria, Integer startPage, Integer pageSize,String sortField, Boolean ascending,QueryConjunctionType conjuncationType) {
			
		return (List<ResCategoryOrderCategory>) super.load(ResCategoryOrderCategory.class , criteria , startPage , pageSize ,  sortField , ascending ,  conjuncationType );
	}
