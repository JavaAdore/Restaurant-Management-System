...
public class ResButtonPermissionSettingsDAOImpl extends AbstractDAO implements ResButtonPermissionSettingsDAO  , Serializable {
	...
	@Override
	public List<ResButtonPermissionSettings> load(Map<String, Object> criteria,QueryConjunctionType conjuncationType) {
			
			return (List<ResButtonPermissionSettings>) super.load(ResButtonPermissionSettings.class , criteria ,  conjuncationType );
	}
	...
	public List<ResButtonPermissionSettings> load(Map<String, Object> criteria, Integer startPage, Integer pageSize,String sortField, Boolean ascending,QueryConjunctionType conjuncationType) {
		...
		return (List<ResButtonPermissionSettings>) super.load(ResButtonPermissionSettings.class , criteria , startPage , pageSize ,  sortField , ascending ,  conjuncationType );
	}
