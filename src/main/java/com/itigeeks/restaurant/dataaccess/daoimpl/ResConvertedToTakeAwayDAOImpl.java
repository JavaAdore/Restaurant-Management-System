 ...
 */
@Repository
public class ResConvertedToTakeAwayDAOImpl extends AbstractDAO implements
    ResConvertedToTakeAwayDAO, Serializable {
  ...
  public List<ResConvertedToTakeAway> load(Map<String, Object> criteria,
    ...
    return (List<ResConvertedToTakeAway>) super.load(ResConvertedToTakeAway.class, criteria,
        conjuncationType);
  }
