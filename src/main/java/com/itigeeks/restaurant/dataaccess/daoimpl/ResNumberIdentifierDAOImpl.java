...
public class ResNumberIdentifierDAOImpl extends AbstractDAO implements ResNumberIdentifierDAO  , Serializable {
	...
	@Override
	public List<ResNumberIdentifier> load(Map<String, Object> criteria,QueryConjunctionType conjuncationType) {
			
			return (List<ResNumberIdentifier>) super.load(ResNumberIdentifier.class , criteria ,  conjuncationType );
	}
	...
	public List<ResNumberIdentifier> load(Map<String, Object> criteria, Integer startPage, Integer pageSize,String sortField, Boolean ascending,QueryConjunctionType conjuncationType) {
		...
		return (List<ResNumberIdentifier>) super.load(ResNumberIdentifier.class , criteria , startPage , pageSize ,  sortField , ascending ,  conjuncationType );
	}
