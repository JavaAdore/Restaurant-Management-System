 ...
 */
@Repository
public class ResDeliveryChargesDAOImpl extends AbstractDAO implements ResDeliveryChargesDAO,
    Serializable {
  ...
  public List<ResDeliveryCharges> load(Map<String, Object> criteria,
    ...
    return (List<ResDeliveryCharges>) super.load(ResDeliveryCharges.class, criteria,
        conjuncationType);
  }
  ...
  public List<ResDeliveryCharges> load(Map<String, Object> criteria, Integer startPage,
    ...
    return (List<ResDeliveryCharges>) super.load(ResDeliveryCharges.class, criteria, startPage,
