...
public class ResVoucherExclusionsDAOImpl extends AbstractDAO implements ResVoucherExclusionsDAO  , Serializable {
	...
	@Override
	public List<ResVoucherExclusions> load(Map<String, Object> criteria,QueryConjunctionType conjuncationType) {
			
			return (List<ResVoucherExclusions>) super.load(ResVoucherExclusions.class , criteria ,  conjuncationType );
	}

	@Override
	public List<ResVoucherExclusions> load(Map<String, Object> criteria, Integer startPage, Integer pageSize,QueryConjunctionType conjuncationType) {
	...
	@Override
	public List<ResVoucherExclusions> load(Map<String, Object> criteria, Integer startPage, Integer pageSize,String sortField, Boolean ascending,QueryConjunctionType conjuncationType) {
			
		return (List<ResVoucherExclusions>) super.load(ResVoucherExclusions.class , criteria , startPage , pageSize ,  sortField , ascending ,  conjuncationType );
	}
