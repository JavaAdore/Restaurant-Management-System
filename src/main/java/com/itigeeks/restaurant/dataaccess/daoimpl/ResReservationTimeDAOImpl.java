...
public class ResReservationTimeDAOImpl extends AbstractDAO implements ResReservationTimeDAO  , Serializable {
	...
	@Override
	public List<ResReservationTime> load(Map<String, Object> criteria,QueryConjunctionType conjuncationType) {
			
			return (List<ResReservationTime>) super.load(ResReservationTime.class , criteria ,  conjuncationType );
	}

	@Override
	public List<ResReservationTime> load(Map<String, Object> criteria, Integer startPage, Integer pageSize,QueryConjunctionType conjuncationType) {
	...
	@Override
	public List<ResReservationTime> load(Map<String, Object> criteria, Integer startPage, Integer pageSize,String sortField, Boolean ascending,QueryConjunctionType conjuncationType) {
			
		return (List<ResReservationTime>) super.load(ResReservationTime.class , criteria , startPage , pageSize ,  sortField , ascending ,  conjuncationType );
	}
