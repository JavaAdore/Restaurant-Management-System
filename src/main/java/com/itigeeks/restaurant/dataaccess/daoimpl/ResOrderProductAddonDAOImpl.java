...
public class ResOrderProductAddonDAOImpl extends AbstractDAO implements ResOrderProductAddonDAO  , Serializable {
	...
	@Override
	public List<ResOrderProductAddon> load(Map<String, Object> criteria,QueryConjunctionType conjuncationType) {
			
			return (List<ResOrderProductAddon>) super.load(ResOrderProductAddon.class , criteria ,  conjuncationType );
	}

	@Override
	public List<ResOrderProductAddon> load(Map<String, Object> criteria, Integer startPage, Integer pageSize,QueryConjunctionType conjuncationType) {
	...
	@Override
	public List<ResOrderProductAddon> load(Map<String, Object> criteria, Integer startPage, Integer pageSize,String sortField, Boolean ascending,QueryConjunctionType conjuncationType) {
			
		return (List<ResOrderProductAddon>) super.load(ResOrderProductAddon.class , criteria , startPage , pageSize ,  sortField , ascending ,  conjuncationType );
	}
