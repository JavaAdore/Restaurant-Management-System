...
public class ResCustomerAddressDAOImpl extends AbstractDAO implements ResCustomerAddressDAO  , Serializable {
	...
	@Override
	public List<ResCustomerAddress> load(Map<String, Object> criteria,QueryConjunctionType conjuncationType) {
			
			return (List<ResCustomerAddress>) super.load(ResCustomerAddress.class , criteria ,  conjuncationType );
	}

	@Override
	public List<ResCustomerAddress> load(Map<String, Object> criteria, Integer startPage, Integer pageSize,QueryConjunctionType conjuncationType) {
	...
	@Override
	public List<ResCustomerAddress> load(Map<String, Object> criteria, Integer startPage, Integer pageSize,String sortField, Boolean ascending,QueryConjunctionType conjuncationType) {
			
		return (List<ResCustomerAddress>) super.load(ResCustomerAddress.class , criteria , startPage , pageSize ,  sortField , ascending ,  conjuncationType );
	}
