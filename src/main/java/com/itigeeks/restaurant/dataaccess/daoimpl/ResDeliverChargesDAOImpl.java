 ...
 */
@Repository
public class ResDeliverChargesDAOImpl extends AbstractDAO implements ResDeliverChargesDAO,
    Serializable {
  ...
  public List<ResDeliverCharges> load(Map<String, Object> criteria,
    ...
    return (List<ResDeliverCharges>) super
        .load(ResDeliverCharges.class, criteria, conjuncationType);
  }
  ...
  public List<ResDeliverCharges> load(Map<String, Object> criteria, Integer startPage,
    ...
    return (List<ResDeliverCharges>) super.load(ResDeliverCharges.class, criteria, startPage,
