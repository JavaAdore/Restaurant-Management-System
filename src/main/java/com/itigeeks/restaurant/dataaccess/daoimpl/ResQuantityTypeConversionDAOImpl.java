 ...
 */
@Repository
public class ResQuantityTypeConversionDAOImpl extends AbstractDAO implements
    ResQuantityTypeConversionDAO, Serializable {
  ...
  public List<ResQuantityTypeConversion> load(Map<String, Object> criteria,
    ...
    return (List<ResQuantityTypeConversion>) super.load(ResQuantityTypeConversion.class, criteria,
        conjuncationType);
  }
