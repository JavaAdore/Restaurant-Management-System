 ...
 */
@Repository
public class ResButtonPermissionTypeDAOImpl extends AbstractDAO implements
    ResButtonPermissionTypeDAO, Serializable {
  ...
  public List<ResButtonPermissionType> load(Map<String, Object> criteria,
    ...
    return (List<ResButtonPermissionType>) super.load(ResButtonPermissionType.class, criteria,
        conjuncationType);
  }
