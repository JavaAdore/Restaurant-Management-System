...
public class ResButtonPermissionTypeDAOImpl extends AbstractDAO implements ResButtonPermissionTypeDAO  , Serializable {
	...
	@Override
	public List<ResButtonPermissionType> load(Map<String, Object> criteria,QueryConjunctionType conjuncationType) {
			
			return (List<ResButtonPermissionType>) super.load(ResButtonPermissionType.class , criteria ,  conjuncationType );
	}
	...
	public List<ResButtonPermissionType> load(Map<String, Object> criteria, Integer startPage, Integer pageSize,String sortField, Boolean ascending,QueryConjunctionType conjuncationType) {
		...
		return (List<ResButtonPermissionType>) super.load(ResButtonPermissionType.class , criteria , startPage , pageSize ,  sortField , ascending ,  conjuncationType );
	}
	...
	public Integer getCount(Map<String, Object> criteria,QueryConjunctionType conjuncationType) {
		return super.getCount(ResButtonPermissionType.class  , criteria ,conjuncationType) ;
	}
