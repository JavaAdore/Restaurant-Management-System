...
public class ResFlaggedOccassionDAOImpl extends AbstractDAO implements ResFlaggedOccassionDAO  , Serializable {
	...
	@Override
	public List<ResFlaggedOccassion> load(Map<String, Object> criteria,QueryConjunctionType conjuncationType) {
			
			return (List<ResFlaggedOccassion>) super.load(ResFlaggedOccassion.class , criteria ,  conjuncationType );
	}

	@Override
	public List<ResFlaggedOccassion> load(Map<String, Object> criteria, Integer startPage, Integer pageSize,QueryConjunctionType conjuncationType) {
	...
	@Override
	public List<ResFlaggedOccassion> load(Map<String, Object> criteria, Integer startPage, Integer pageSize,String sortField, Boolean ascending,QueryConjunctionType conjuncationType) {
			
		return (List<ResFlaggedOccassion>) super.load(ResFlaggedOccassion.class , criteria , startPage , pageSize ,  sortField , ascending ,  conjuncationType );
	}
