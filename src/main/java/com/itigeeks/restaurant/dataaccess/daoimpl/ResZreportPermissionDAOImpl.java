 ...
 */
@Repository
public class ResZreportPermissionDAOImpl extends AbstractDAO implements ResZreportPermissionDAO,
    Serializable {
  ...
  public List<ResZreportPermission> load(Map<String, Object> criteria,
    ...
    return (List<ResZreportPermission>) super.load(ResZreportPermission.class, criteria,
        conjuncationType);
  }

  @Override
  public List<ResZreportPermission> load(Map<String, Object> criteria, Integer startPage,
  ...
  public List<ResZreportPermission> load(Map<String, Object> criteria, Integer startPage,
    ...
    return (List<ResZreportPermission>) super.load(ResZreportPermission.class, criteria, startPage,
