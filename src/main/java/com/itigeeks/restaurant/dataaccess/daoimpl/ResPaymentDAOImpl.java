...
public class ResPaymentDAOImpl extends AbstractDAO implements ResPaymentDAO  , Serializable {
	...
	@Override
	public List<ResPayment> load(Map<String, Object> criteria, Integer startPage, Integer pageSize,QueryConjunctionType conjuncationType) {
	...
	@Override
	public List<ResPayment> load(Map<String, Object> criteria, Integer startPage, Integer pageSize,String sortField, Boolean ascending,QueryConjunctionType conjuncationType) {
			
		return (List<ResPayment>) super.load(ResPayment.class , criteria , startPage , pageSize ,  sortField , ascending ,  conjuncationType );
	}
