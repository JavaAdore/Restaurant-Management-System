...
public interface ResReservationStatusDAO {
	...
	public List<ResReservationStatus> load(Map<String, Object> criteria,QueryConjunctionType queryConjunctionType);

	public List<ResReservationStatus> load( Map<String, Object> criteria , Integer firstPage , Integer pageSize ) ;
