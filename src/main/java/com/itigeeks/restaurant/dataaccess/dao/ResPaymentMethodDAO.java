...
public interface ResPaymentMethodDAO {
	...
	public List<ResPaymentMethod> load(Map<String, Object> criteria,QueryConjunctionType queryConjunctionType);

	public List<ResPaymentMethod> load( Map<String, Object> criteria , Integer firstPage , Integer pageSize ) ;
