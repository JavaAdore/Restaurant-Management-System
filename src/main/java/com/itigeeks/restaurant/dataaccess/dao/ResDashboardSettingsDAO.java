...
public interface ResDashboardSettingsDAO {
	...
	public List<ResDashboardSettings> load(Map<String, Object> criteria,QueryConjunctionType queryConjunctionType);

	public List<ResDashboardSettings> load( Map<String, Object> criteria , Integer firstPage , Integer pageSize ) ;
