...
public interface ResOrderDeleteLogDAO {
	...
	public List<ResOrderDeleteLog> load(Map<String, Object> criteria,QueryConjunctionType queryConjunctionType);

	public List<ResOrderDeleteLog> load( Map<String, Object> criteria , Integer firstPage , Integer pageSize ) ;
