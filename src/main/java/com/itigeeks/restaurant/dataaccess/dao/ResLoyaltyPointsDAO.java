...
public interface ResLoyaltyPointsDAO {
	...
	public List<ResLoyaltyPoints> load(Map<String, Object> criteria,QueryConjunctionType queryConjunctionType);

	public List<ResLoyaltyPoints> load( Map<String, Object> criteria , Integer firstPage , Integer pageSize ) ;
