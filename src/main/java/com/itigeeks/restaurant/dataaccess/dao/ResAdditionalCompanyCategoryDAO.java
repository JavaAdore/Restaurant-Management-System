...
public interface ResAdditionalCompanyCategoryDAO {
	...
	public List<ResAdditionalCompanyCategory> load(Map<String, Object> criteria,QueryConjunctionType queryConjunctionType);

	public List<ResAdditionalCompanyCategory> load( Map<String, Object> criteria , Integer firstPage , Integer pageSize ) ;
