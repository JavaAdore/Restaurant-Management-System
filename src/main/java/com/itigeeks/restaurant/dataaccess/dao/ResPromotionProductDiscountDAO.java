...
public interface ResPromotionProductDiscountDAO {
	...
	public List<ResPromotionProductDiscount> load(Map<String, Object> criteria,QueryConjunctionType queryConjunctionType);

	public List<ResPromotionProductDiscount> load( Map<String, Object> criteria , Integer firstPage , Integer pageSize ) ;
