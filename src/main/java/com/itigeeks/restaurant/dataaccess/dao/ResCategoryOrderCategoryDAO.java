...
public interface ResCategoryOrderCategoryDAO {
	...
	public List<ResCategoryOrderCategory> load(Map<String, Object> criteria,QueryConjunctionType queryConjunctionType);

	public List<ResCategoryOrderCategory> load( Map<String, Object> criteria , Integer firstPage , Integer pageSize ) ;
