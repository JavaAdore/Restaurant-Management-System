...
public interface ResReservationTypeDAO {
	...
	public List<ResReservationType> load(Map<String, Object> criteria,QueryConjunctionType queryConjunctionType);

	public List<ResReservationType> load( Map<String, Object> criteria , Integer firstPage , Integer pageSize ) ;
