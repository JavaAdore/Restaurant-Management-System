...
public interface ResDeliveryChargesDAO {
	...
	public List<ResDeliveryCharges> load(Map<String, Object> criteria,QueryConjunctionType queryConjunctionType);

	public List<ResDeliveryCharges> load( Map<String, Object> criteria , Integer firstPage , Integer pageSize ) ;
