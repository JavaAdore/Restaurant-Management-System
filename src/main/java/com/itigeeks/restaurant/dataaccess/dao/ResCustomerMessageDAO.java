...
public interface ResCustomerMessageDAO {
	...
	public List<ResCustomerMessage> load(Map<String, Object> criteria,QueryConjunctionType queryConjunctionType);

	public List<ResCustomerMessage> load( Map<String, Object> criteria , Integer firstPage , Integer pageSize ) ;
