...
public interface ResProductIngredientDAO {
	...
	public List<ResProductIngredient> load(Map<String, Object> criteria,QueryConjunctionType queryConjunctionType);

	public List<ResProductIngredient> load( Map<String, Object> criteria , Integer firstPage , Integer pageSize ) ;
