...
public interface ResProductPurchaseHistoryDAO {
	...
	public List<ResProductPurchaseHistory> load(Map<String, Object> criteria,QueryConjunctionType queryConjunctionType);

	public List<ResProductPurchaseHistory> load( Map<String, Object> criteria , Integer firstPage , Integer pageSize ) ;
