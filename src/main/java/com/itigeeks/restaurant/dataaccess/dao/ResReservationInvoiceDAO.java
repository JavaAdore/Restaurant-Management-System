...
public interface ResReservationInvoiceDAO {
	...
	public List<ResReservationInvoice> load(Map<String, Object> criteria,QueryConjunctionType queryConjunctionType);

	public List<ResReservationInvoice> load( Map<String, Object> criteria , Integer firstPage , Integer pageSize ) ;
