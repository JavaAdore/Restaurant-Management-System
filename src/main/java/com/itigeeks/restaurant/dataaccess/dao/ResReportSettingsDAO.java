...
public interface ResReportSettingsDAO {
	...
	public List<ResReportSettings> load(Map<String, Object> criteria,QueryConjunctionType queryConjunctionType);

	public List<ResReportSettings> load( Map<String, Object> criteria , Integer firstPage , Integer pageSize ) ;
