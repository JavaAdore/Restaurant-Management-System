...
public interface ResDiscountProductDAO {
	...
	public List<ResDiscountProduct> load(Map<String, Object> criteria,QueryConjunctionType queryConjunctionType);

	public List<ResDiscountProduct> load( Map<String, Object> criteria , Integer firstPage , Integer pageSize ) ;
