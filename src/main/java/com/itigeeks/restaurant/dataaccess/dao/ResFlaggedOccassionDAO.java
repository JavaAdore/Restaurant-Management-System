...
public interface ResFlaggedOccassionDAO {
	...
	public List<ResFlaggedOccassion> load(Map<String, Object> criteria,QueryConjunctionType queryConjunctionType);

	public List<ResFlaggedOccassion> load( Map<String, Object> criteria , Integer firstPage , Integer pageSize ) ;
