...
public interface ResReservationTimeDAO {
	...
	public List<ResReservationTime> load(Map<String, Object> criteria,QueryConjunctionType queryConjunctionType);

	public List<ResReservationTime> load( Map<String, Object> criteria , Integer firstPage , Integer pageSize ) ;
