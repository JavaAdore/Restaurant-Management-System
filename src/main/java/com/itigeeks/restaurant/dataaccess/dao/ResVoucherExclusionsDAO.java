...
public interface ResVoucherExclusionsDAO {
	...
	public List<ResVoucherExclusions> load(Map<String, Object> criteria,QueryConjunctionType queryConjunctionType);

	public List<ResVoucherExclusions> load( Map<String, Object> criteria , Integer firstPage , Integer pageSize ) ;
