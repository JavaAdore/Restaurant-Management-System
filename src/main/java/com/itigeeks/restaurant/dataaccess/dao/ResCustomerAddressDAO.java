...
public interface ResCustomerAddressDAO {
	...
	public List<ResCustomerAddress> load(Map<String, Object> criteria,QueryConjunctionType queryConjunctionType);

	public List<ResCustomerAddress> load( Map<String, Object> criteria , Integer firstPage , Integer pageSize ) ;
