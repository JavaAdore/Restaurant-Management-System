...
public interface ResProductAddonDAO {
	...
	public List<ResProductAddon> load(Map<String, Object> criteria,QueryConjunctionType queryConjunctionType);

	public List<ResProductAddon> load( Map<String, Object> criteria , Integer firstPage , Integer pageSize ) ;
