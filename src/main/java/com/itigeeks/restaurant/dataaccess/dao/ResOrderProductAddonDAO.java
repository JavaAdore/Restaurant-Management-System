...
public interface ResOrderProductAddonDAO {
	...
	public List<ResOrderProductAddon> load(Map<String, Object> criteria,QueryConjunctionType queryConjunctionType);

	public List<ResOrderProductAddon> load( Map<String, Object> criteria , Integer firstPage , Integer pageSize ) ;
