...
public interface ResAdditionalCompanyDAO {
	...
	public List<ResAdditionalCompany> load(Map<String, Object> criteria,QueryConjunctionType queryConjunctionType);

	public List<ResAdditionalCompany> load( Map<String, Object> criteria , Integer firstPage , Integer pageSize ) ;
