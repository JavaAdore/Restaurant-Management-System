...
public interface ResPrepLocationDAO {
	...
	public List<ResPrepLocation> load(Map<String, Object> criteria,QueryConjunctionType queryConjunctionType);

	public List<ResPrepLocation> load( Map<String, Object> criteria , Integer firstPage , Integer pageSize ) ;
